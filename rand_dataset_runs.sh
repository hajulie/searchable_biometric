...
python3 dataset_test.py --parallel=0 --dataset=synth --oram_constant_accesses=56 --nb_trees=1200 --lsh_size=21 --dataset_size=2500 --nb_queries=500 --same_t=.3 --oram=1 > synth2500.txt
python3 dataset_test.py --parallel=0 --dataset=synth --oram_constant_accesses=72 --nb_trees=1300 --lsh_size=22 --dataset_size=5000 --nb_queries=500 --same_t=.3 --oram=1 > synth5000.txt
