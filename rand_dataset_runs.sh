...
python3 dataset_test.py --parallel=0 --dataset=synth --oram_constant_accesses=72 --nb_trees=1300 --lsh_size=22 --dataset_size=5000 --nb_queries=100 --same_t=.3 --oram=1 > synth5000.txt
